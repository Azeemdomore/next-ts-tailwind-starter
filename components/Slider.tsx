...
const Slider = ({ name }: Props) => {
  ...
  const renderSliderSteps = () => {
    switch (sliderSteps) {
      case 1:
        return (
          <div className="h-full w-full absolute bg-[url(/img/slideOne.jpg)] bg-cover bg-no-repeat bg-center duration-500 p-20">
      ...
      case 2:
        return (
          <div className="h-full w-full absolute  bg-[url(/img/slideTwo.jpg)] bg-cover bg-no-repeat bg-center duration-500 p-20">
            <div className="h-80 w-[19rem] bg-white p-10 space-y-3 mt-5">
      ...
      case 3:
        return (
          <div className="h-full w-full absolute  bg-[url(/img/slideThree.jpg)] bg-cover bg-no-repeat bg-center duration-500 p-20">
            <div className="h-80 w-[19rem] bg-white p-10 space-y-3 mt-5">
  ...
  return (
    <>
      <div className="flex items-center gap-16 h-full w-full">
        ...
        <div className="relative w-[1190px] h-[530px]">
          {renderSliderSteps()}
        </div>
      </div>
    </>
